...
class EventApi
{
     ...
     * Create a new event
     *
     * @param \Metatavu\MantyharjuTheme\LinkedEvents\Model\Event $eventObject  (optional)
     ...
     * @param \Metatavu\MantyharjuTheme\LinkedEvents\Model\Event $eventObject  (optional)
     * @throws \Metatavu\MantyharjuTheme\LinkedEvents\ApiException on non-2xx response
     * @return array of \Metatavu\MantyharjuTheme\LinkedEvents\Model\Event, HTTP status code, HTTP response headers (array of strings)
     */
    public function eventCreateWithHttpInfo($eventObject = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Metatavu\MantyharjuTheme\LinkedEvents\Model\Event',
                '/event/'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Metatavu\MantyharjuTheme\LinkedEvents\Model\Event', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Metatavu\MantyharjuTheme\LinkedEvents\Model\Event', $e->getResponseHeaders());
     ...
     * @param string $language Search for events in given language (optional)
     * @param string $publicationStatus Filter events by publication status (either draft or public) (optional)
     * @throws \Metatavu\MantyharjuTheme\LinkedEvents\ApiException on non-2xx response
     * @return \Metatavu\MantyharjuTheme\LinkedEvents\Model\InlineResponse200
     */
     ...
     * @param string $publicationStatus Filter events by publication status (either draft or public) (optional)
     * @throws \Metatavu\MantyharjuTheme\LinkedEvents\ApiException on non-2xx response
     * @return array of \Metatavu\MantyharjuTheme\LinkedEvents\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function eventListWithHttpInfo($include = null, $text = null, $lastModifiedSince = null, $start = null, $end = null, $bbox = null, $dataSource = null, $location = null, $showAll = null, $division = null, $keyword = null, $recurring = null, $minDuration = null, $maxDuration = null, $publisher = null, $sort = null, $page = null, $pageSize = null, $addressLocalityFi = null, $addressLocalitySv = null, $addressLocalityEn = null, $language = null, $publicationStatus = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Metatavu\MantyharjuTheme\LinkedEvents\Model\InlineResponse200',
                '/event/'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Metatavu\MantyharjuTheme\LinkedEvents\Model\InlineResponse200', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Metatavu\MantyharjuTheme\LinkedEvents\Model\InlineResponse200', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param \Metatavu\MantyharjuTheme\LinkedEvents\Model\Event $eventObject Event object that should replace the existing event, note that some implementations may retain unspecified fields at their original values. (optional)
     * @throws \Metatavu\MantyharjuTheme\LinkedEvents\ApiException on non-2xx response
     * @return \Metatavu\MantyharjuTheme\LinkedEvents\Model\Event
     */
